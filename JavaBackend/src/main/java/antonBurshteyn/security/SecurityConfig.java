...
import antonBurshteyn.login.jwt.JwtAuthenticationFilter;
...
//                        .requestMatchers("/photos/search/**").authenticated()
//                        .requestMatchers("/photos/list", "/photos/delete/**").hasRole("ADMIN")
